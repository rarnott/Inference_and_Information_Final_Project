...
import numpy as np
import random
from transitions import Epsilon_Transition,Uniform_Transition
...
def decode(ciphertext, output_file_name):
	...
	# identity = {a:a for a in english.alphabet}
	# print("True log-likelihood:", english.log_likelihood(plaintext,identity))
